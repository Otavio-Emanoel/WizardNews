...
export function Navigation() {
	...
	const navItems = [
		...
		{ href: "/education-and-sustainable-culture", label: "Education & Sustainable Culture" },
					...
					<div className="hidden md:flex items-center space-x-8">
						{navItems.map((item) => (
							<Link
								key={item.href}
								href={item.href}
								className="group relative text-center inline-flex items-center py-2 text-foreground/85 transition-colors duration-200 hover:text-foreground"
							>
